...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Bean
	public RestAuthenticationEntryPoint restServicesEntrryPoint() {
...
//		http.cors();//bat chia se tai nguyen
		//disable crsf cho duong dan /rest/**
		http.csrf().ignoringAntMatchers("/rest/**");
		
		http.authorizeRequests().antMatchers("/rest/login**").permitAll();
		
		http.antMatcher("/rest/**").httpBasic().authenticationEntryPoint(restServicesEntrryPoint()).and()
